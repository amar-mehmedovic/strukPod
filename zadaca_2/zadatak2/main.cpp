...
MojVector<radnik> processData(std::ifstream& input) {
    MojVector<radnik> Radnici;
    if (input.is_open()) {
...
MojVector<radnik> mergeData(MojVector<radnik>& acme,
			    MojVector<radnik>& globex) {
    MojVector<radnik> merged;
...
void sortData(MojVector<radnik>& corpexRadnici) {
...
void outputDataToFile(MojVector<radnik>& corpexRadnici) {
...
int main(int argc, char* argv[]) {
    ...
    MojVector<radnik> acmeRadnici = processData(input);
    input.close();
    input.open("globex.txt");
    MojVector<radnik> globexRadnici = processData(input);
    MojVector<radnik> corpexRadnici = mergeData(acmeRadnici, globexRadnici);
